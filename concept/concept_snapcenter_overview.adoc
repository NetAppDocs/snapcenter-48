...
** Data that is on ONTAP FAS or AFF primary & secondary systems and protected to local StorageGRID object storage using NetApp backup and recovery integration
...
** Data that is on ONTAP FAS or AFF primary and secondary systems and protected to object and archive storage in cloud using NetApp backup and recovery integration
